        ...
        <Grid>
          <Cell col={4}>
            <div style={{ textAlign: 'center' }}>
              <img src="https://www.shareicon.net/download/2015/09/18/103157_man_512x512.png" style={{ height: '100px' }} />
            </div>
            <h2 style={{ paddingTop: '0em' }}> Omkar </h2>
            <h4 style={{ color: 'grey' }}>Programmer</h4>
            <hr style={{ borderTop: '3px solid #32CD32', width: '50%' }} />
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Education
              ...
              schoolDescription="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since t"
            />
            <hr style={{ borderTop: '3px solid #32CD32' }} />
